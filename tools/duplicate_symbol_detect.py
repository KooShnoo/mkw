...
if dups > 0:
    ...
    print(f"NOTE this script is kinda stupid and has a lot of false positives, use ur brain.\nlike if the dups are in diff sections or executables or smth, its fine probably", file=sys.stderr)
    exit(1)
else:
