...
#define KCL_TYPE_FLOOR (\
    KCL_TYPE_BIT(Field::COL_TYPE_ROAD) | \
    KCL_TYPE_BIT(Field::COL_TYPE_SLIPPERY_ROAD) | \
    KCL_TYPE_BIT(Field::COL_TYPE_WEAK_OFF_ROAD) | \
    KCL_TYPE_BIT(Field::COL_TYPE_OFF_ROAD) | \
    KCL_TYPE_BIT(Field::COL_TYPE_HEAVY_OFF_ROAD) | \
    KCL_TYPE_BIT(Field::COL_TYPE_SLIPPERY_ROAD_2) | \
    KCL_TYPE_BIT(Field::COL_TYPE_BOOST_PAD) | \
    KCL_TYPE_BIT(Field::COL_TYPE_BOOST_RAMP) | \
    KCL_TYPE_BIT(Field::COL_TYPE_JUMP_PAD) | \
    KCL_TYPE_BIT(Field::COL_TYPE_ITEM_ROAD) | \
    KCL_TYPE_BIT(Field::COL_TYPE_SOLID_OOB) | \
    KCL_TYPE_BIT(Field::COL_TYPE_MOVING_WATER) | \
    KCL_TYPE_BIT(Field::COL_TYPE_HALFPIPE_RAMP) | \
    KCL_TYPE_BIT(Field::COL_TYPE_MOVING_ROAD) | \
    KCL_TYPE_BIT(Field::COL_TYPE_STICKY_ROAD) | \
    KCL_TYPE_BIT(Field::COL_TYPE_ROAD2) | \
    KCL_TYPE_BIT(Field::COL_TYPE_ROTATING_ROAD))
